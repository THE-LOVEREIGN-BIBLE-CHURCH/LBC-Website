...
// esbuild-css-modules-plugin-namespace:C:\Users\silvi\AppData\Local\Temp\tmp-16292-jAec7S5WDXPR\lightbox.js-react\src\components\SlideshowLightbox\SlideshowLightbox.module.css.js
var digest = "9d73527626f8a8a1042de989c031b5cbe703d01619b535abb35afcabe77b8abe";
...
var import_react_div_100vh = __toESM(require("react-div-100vh"));
...
var SlideshowLightbox = React.forwardRef(
  (props, ref) => {
    ...
    const [pinch, setPinch] = (0, import_react2.useState)(false);
    ...
    const div100vhHeight = (0, import_react_div_100vh2.use100vh)();
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${initWrapperClassname()}`, children: [
      renderPreviewImages(),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_div_100vh.default, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_framer_motion.AnimatePresence, { initial: false, mode: "wait", children: showModal !== false && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_portal.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { height: lboxHeight }, children: [
...
var defaultTheme2 = "lightbox";
var Image = (props) => {
  const [backgroundColor, setBackgroundColor] = (0, import_react4.useState)(props.backgroundColor ? props.backgroundColor : themes2[defaultTheme2].background);
  const [iconColor, setIconColor] = (0, import_react4.useState)(props.iconColor ? props.iconColor : themes2[defaultTheme2].iconColor);
  const [fullScreen, setFullScreen] = (0, import_react4.useState)(props.fullScreen ? props.fullScreen : false);
  const [modalCloseOption, setModalCloseOption] = (0, import_react4.useState)(props.modalClose ? props.modalClose : "default");
  const [disableZoom, setDisableZoom] = (0, import_react4.useState)(
    props.disableImageZoom ? props.disableImageZoom : false
  );
  const [imageRoundedBorder, setImageRoundedBorder] = (0, import_react4.useState)(
    props.roundedImages ? props.roundedImages : false
  );
  const [displayFullScreenIcon, setDisplayFullScreenIcon] = (0, import_react4.useState)(
    props.showFullScreenIcon ? props.showFullScreenIcon : true
  );
  const [className, setClassName] = (0, import_react4.useState)(
    props.className ? props.className : ""
  );
  const [imgWrapperClass, setImgWrapperClass] = (0, import_react4.useState)(
    props.wrapperClassName ? props.wrapperClassName : ""
  );
  const [width, setWidth] = (0, import_react4.useState)(
    props.width ? props.width : null
  );
  const [height, setHeight] = (0, import_react4.useState)(
    props.height ? props.height : null
  );
  const [lightboxImgClassName, setLightboxImgClassName] = (0, import_react4.useState)(
    props.lightboxImgClass ? props.lightboxImgClass : ""
  );
  const [imgClass, setImgClass] = (0, import_react4.useState)(
    props.className ? props.className : ""
  );
  const [displayMagnificationIcons, setDisplayMagnificationIcons] = (0, import_react4.useState)(
    props.showMagnificationIcons ? props.showMagnificationIcons : true
  );
  const [displayControls, setDisplayControls] = (0, import_react4.useState)(
    props.showControls ? props.showControls : true
  );
  const [showDownloadBtn, setShowDownloadBtn] = (0, import_react4.useState)(
    props.downloadImages ? props.downloadImages : false
  );
  const [isRTL, setIsRTL] = (0, import_react4.useState)(props.rtl ? props.rtl : false);
  const [lightboxIdentifier, setLightboxIdentifier] = (0, import_react4.useState)(
    props.lightboxIdentifier ? props.lightboxIdentifier : ""
  );
  const [frameworkID, setFrameworkID] = (0, import_react4.useState)(
    props.framework ? props.framework : ""
  );
  ...
  (0, import_react4.useEffect)(() => {
    if (props.theme) {
      if (themes2[props.theme]) {
        setBackgroundColor(themes2[props.theme].background);
        setIconColor(themes2[props.theme].iconColor);
      }
    }
...
var initLightboxJS = (licenseKey, plan_type) => {
  ...
  import_axios.default.post("https://lightboxjs-server.herokuapp.com/license", body).then(function(response) {
