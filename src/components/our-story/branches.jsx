...
export default function ChurchLeadership() {
  ...
  const placeHolderBranches = [
    ...
    { name: "Chief Elder", pastor: "Charles Phillips Fiadjoe", location: "Koforidua", image: ChiefElderCharlesFiadjoe },
    { name: "Chief Elder", pastor: "Prosper Asamoah", location: "Pantang", image: CEElderProsperAsamoah },
    { name: "Chief Elder", pastor: "Herbert Togbe", location: "Tantra", image: CEHerbertTogbey },
    { name: "Pastor", pastor: "Michael Agbadji", location: "Bole", image: noPicture },
    { name: "Chief Elder", pastor: "Terrick Naador", location: "East Legon", image: CETerrickNaador },
    { name: "Pastor", pastor: "Abraham Tetteh", location: "Kumasi", image: PastorAbrahamTetteh },
    { name: "Chief Elder", pastor: "Essien Nana", location: "Cape Coast", image: CEElderEssienNana },
    { name: "Pastor", pastor: "Vitalis Kanyerigbani", location: "Winneba", image: PastorVitalis },
    { name: "Chief Elder", pastor: "Peter Hagin Wealth", location: "UPSA", image: CEPeterHaginWealth },
    { name: "Chief Elder", pastor: "Frederick Agyemang", location: "North Legon", image: CEFredAgyemang },
    { name: "Pastor", pastor: "Charles Yekple", location: "Korle-Bu", image: PastorCharles },
