...
const LadyPastorAlexaHaginWealth =
  "/assets/img/church_leaders/LadyPastorAlexaHagin-Wealth.jpg";
const LadyPastorAliceOhenebaAsare =
  "/assets/img/church_leaders/LadyPastorAliceOhenebaAsare.png";
const PastorAbrahamTetteh =
  "/assets/img/church_leaders/PastorAbrahamTetteh.jpg";
const PastorAlbertOseiAwuah =
  "/assets/img/church_leaders/PastorAlbertOsei-Awuah.png";
...
const PastorEbenezerKotey =
  "/assets/img/church_leaders/PastorEbenezerKotey.png";
...
export default function ChurchLeadership() {
  ...
  const placeHolderBranches = [
    {
      name: "Pastor",
      pastor: "Sampson Agborson",
      location: "Headquarters",
      image: ProphetSampson,
    },
    {
      name: "Pastor",
      pastor: "Eric Sappor",
    ...
    {
      name: "Pastor",
      pastor: "Albert Boakye",
      location: "Headquarters",
      image: PastorAlbertBoakye,
    },
    {
      name: "Pastor",
      pastor: "Alexa Hagin-Wealth",
      location: "Headquarters",
      image: LadyPastorAlexaHaginWealth,
    },
    {
      name: "Pastor",
      pastor: "Alice Oheneba Asare",
      location: "Headquarters",
      image: LadyPastorAliceOhenebaAsare,
    },
    {
      name: "Pastor",
      pastor: "Evans Oheneba Asare",
      location: "Headquarters",
      image: ProphetEvans,
    },
    {
      name: "Pastor",
      pastor: "Albert Osei Awuah",
      location: "Headquarters",
      image: PastorAlbertOseiAwuah,
    },
    {
      name: "Pastor",
      pastor: "Ebenezer Kotey",
      location: "Headquarters",
      image: PastorEbenezerKotey,
    },
    {
      name: "Pastor",
      pastor: "Emmanuel Fiifi Robertson",
      location: "Ho",
      image: PastorEmmanuelFiifiRobert,
    },
    {
      name: "Pastor",
      pastor: "Emmanuel Yartey",
      location: "Abeka",
      image: PastorEmmanuelYartey,
    },
    {
      name: "Pastor",
      pastor: "Moses Frimpong",
      location: "Sowutuom",
      image: PastorMosesFrimpong,
    },
    {
      name: "Pastor",
      pastor: "Michael Oduro",
      location: "Accra",
    ...
    },
    {
      ...
      location: "Koforidua",
      image: ChiefElderCharlesFiadjoe,
    },
    {
      name: "Chief Elder",
      pastor: "Prosper Asamoah",
      location: "Pantang",
      image: CEElderProsperAsamoah,
    },
    {
      name: "Chief Elder",
      pastor: "Herbert Togbe",
      location: "Tantra",
    ...
    },
    {
      ...
      location: "UPSA",
      image: CEPeterHaginWealth,
    },
    {
      name: "Chief Elder",
      pastor: "Frederick Agyemang",
    ...
    <div className="min-h-screen bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 text-white">
              ...
              {filteredBranches.map((branch, index) => (
                ...
                >
                  <div className="relative mb-3">
                    ...
                    <div
                      className={`absolute -inset-1 rounded-full bg-gradient-to-br ${getGlowColor(index)} blur-md opacity-70 group-hover:opacity-100 transition-opacity duration-300 transform -rotate-12`}
                    ></div>
      ...
      >
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-3 border border-gray-700">
          <h3 className="text-3xl font-bold text-blue-400">27+</h3>{" "}
          {/* Increased size */}
