          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="w-full md:w-1/3 text-center md:text-left">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                <h1 className="text-white text-4xl md:text-5xl font-bold mb-4">Testimonies</h1>
                      ...
                      <div className="relative w-full h-full flex flex-col">
                        ...
                        <div className="p-6 flex-1 flex flex-col">
                          ...
                          <div className="flex items-center mb-4 h-14">
                            ...
                            <div className="ml-3">
                              <h3 className="font-medium text-gray-800 truncate max-w-[150px]">{testimony.name}</h3>
                          ...
                          <div className="h-[100px] mb-4 overflow-hidden relative">
                            <p className="text-gray-700 text-sm line-clamp-4">{testimony.summary}</p>
              ...
              >
                ...
                >
                  <div className={`bg-gradient-to-r ${selectedTestimony.bgGradient} p-6 relative`}>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-white/80 text-sm truncate max-w-[300px]">{selectedTestimony.name}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 overflow-y-auto max-h-[50vh]">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6 whitespace-pre-line">{selectedTestimony.fullStory}</p>
                  </div>
                </motion.div>
              </motion.div>
          )}
